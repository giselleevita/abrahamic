      ...
      <div className="mx-auto max-w-7xl px-4 py-12 sm:px-6">
        <div className="grid gap-10 sm:grid-cols-2 lg:grid-cols-4">
          ...
          <div className="lg:col-span-1">
            <Link href="/" className="text-sm font-semibold text-stone-100">
              Abrahamic Texts
            </Link>
            <p className="mt-3 text-xs leading-relaxed text-stone-400 max-w-xs">
            ...
            <div className="mt-4 flex gap-2">
              <span className="rounded-full bg-blue-900/50 px-2.5 py-0.5 text-[10px] font-medium text-blue-300">Judaism</span>
              <span className="rounded-full bg-red-900/50 px-2.5 py-0.5 text-[10px] font-medium text-red-300">Christianity</span>
              <span className="rounded-full bg-green-900/50 px-2.5 py-0.5 text-[10px] font-medium text-green-300">Islam</span>
            </div>
          </div>
        ...
        <div className="mt-10 border-t border-stone-800 pt-6 flex flex-col gap-1 sm:flex-row sm:items-center sm:justify-between">
